...
class SnapchatBot:
    ...
    def get_positions(self):
        self.print_console("Position your cursor over the camera icon and then press the 'C' key to proceed.")
        ...
        self.print_console("Position your cursor over the arrow down button, and then press the 'C' key.")
        self.wait_for_key_press("c")
        self.arrow_down = pyautogui.position()
        time.sleep(0.5)

        self.print_console("Position your cursor over the Multi Snap button, and then press the 'C' key.")
        self.wait_for_key_press("c")
        self.multi_snap = pyautogui.position()
        time.sleep(0.5)

        self.print_console("Position your cursor over the Edit & Send button, and then press the 'C' key.")
        self.wait_for_key_press("c")
        ...
        self.print_console("Move your mouse to the 'Select All' shortcut, then press the 'C' key. If it doesn't show up, select more than one person in the shortcut.")
        self.wait_for_key_press("c")
    ...
    def update_title(self, shortcut_users):
        ...
        if platform.system() == "Windows":
            ctypes.windll.kernel32.SetConsoleTitleW(f"SnapScore UP | Sent Snaps: {sent_snaps} | Elapsed: {elapsed}s | Developed by @DiningTable on Github \ @Moonveil on Cracked.io")

    def main(self):
        if platform.system() == "Windows":
            os.system("cls")
            ctypes.windll.kernel32.SetConsoleTitleW("SnapScore UP | Developed by @DiningTable on Github \ @Moonveil on Cracked.io")
        else:
            os.system("clear")
        ...
        self.print_console("To stop the operation, press and hold the 'F4' key for approximately 3 seconds.")
        ...
        while True:
            if keyboard.is_pressed("F4"):
                ...
                start_time = time.time()  # Reset timer if key is released
            time.sleep(0.1)
...
# Create an instance of SnapchatBot and run it
obj = SnapchatBot()
obj.main()